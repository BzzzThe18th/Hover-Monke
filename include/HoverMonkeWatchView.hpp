...
DECLARE_CLASS_CUSTOM(HoverMonke, HoverMonkeWatchView, GorillaUI::Components::View, 
    ...
    public:
        ...
        GorillaUI::UISelectionHandler* powerSelector = nullptr;
        GorillaUI::UISelectionHandler* carSpeedSelector = nullptr;
)